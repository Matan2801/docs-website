...
<figcaption>
  Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Destinations**. Use destinations to choose where your notifications are sent.
</figcaption>

1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Enrich and Notify > Destinations**. The destinations table shows information about the existing destinations and allows users to enable, disable, and modify.
...
<figcaption>
  Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Destinations**. Click the **Destinations** tab to see the destinations table.
</figcaption>

### NrAiNotification table [#NrAiNotification]
The NrAiNotification table provides a queriable replica of the [Issue Notifications Log](docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/#issue-notification-log), allowing you to track and analyze issue notifications sent from workflows to different destinations within New Relic using NRQL queries.
